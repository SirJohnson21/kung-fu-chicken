...
export default class FeelingScene extends Phaser.Scene {
    ...
    create() {
        ...
        this.add
            .text(500, 36, "HOW ARE YOU FEELING?", {
                fontSize: "26px",
                color: "#e8e0ff"
            })
            .setOrigin(0.5)
        ...
        this.add
            .text(500, 74, "Pick a box  ·  arrows move  ·  1–4  ·  SPACE / ENTER  ·  ESC — title", {
                fontSize: "13px",
                color: "#a8a0c0",
                wordWrap: { width: 960 },
                align: "center"
        ...
        const centers = getMoodCellCenters(96)
        ...
        FEELING_MOODS.forEach((m, i) => {
            ...
            const bg = this.add
                .rectangle(0, 0, cellW, cellH, 0x2a2840)
    ...
    refreshSelectionHighlight() {
        this.rows.forEach((row, i) => {
            ...
            row.bg.setStrokeStyle(3, on ? 0xd4c4ff : 0x4a4570)
